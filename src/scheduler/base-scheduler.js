...
class BaseScheduler {
  constructor() {
    ...
    this.stats = {
      ...
      mutual_fund_update: { last_run: null, last_success: null, success_count: 0, fail_count: 0, today_success_count: 0, today_fail_count: 0, stats_date: null, status: 'IDLE', message: null },
