    ...
    <div style={{ background: '#f9fafb', minHeight: '100vh' }}>
      ...
      <div style={styles.page}>
        <div style={styles.card}>
          ...
          <h3 style={{ ...styles.h2, fontSize: 18, marginTop: 20 }}>Ezoic Services</h3>
          <p style={styles.p}>
          ...
          <ul style={styles.ul}>
            ...
            <li style={styles.li}>Operating system type and version</li>
            <li style={styles.li}>Device type</li>
            <li style={styles.li}>Language preferences</li>
            <li style={styles.li}>Web browser type</li>
            <li style={styles.li}>Email (in a hashed or encrypted form)</li>
          </ul>
          <p style={styles.p}>
            Ezoic and its partners may use this data in combination with information that has been independently collected to deliver targeted advertisements across various platforms and websites. Ezoic’s partners may also gather additional data, such as unique IDs, advertising IDs, geolocation data, usage data, device information, traffic data, referral sources, and interactions between users and websites or advertisements, to create audience segments for targeted advertising across different devices, browsers, and apps. You can find more information about interest-based advertising and how to manage them <a href="https://youradchoices.com/" target="_blank" rel="noreferrer" style={styles.link}>here</a>.
          </p>
          <p style={styles.p}>
            You can view Ezoic’s privacy policy <a href="https://ezoic.com/privacy/" target="_blank" rel="noreferrer" style={styles.link}>here</a>, or for additional information about Ezoic’s advertising and other partners, you can view Ezoic’s advertising partners <a href="https://www.ezoic.com/privacy-policy/advertising-partners/" target="_blank" rel="noreferrer" style={styles.link}>here</a>.
          </p>
        </div>
      </div>
    </div>
